...
\begin{enumerate}
    ...
    \item \textbf{Full Valuation Methdos}
\end{enumerate}
\end{definition}
  \chapterimage{stock}
...
\chapter{Governance Over Stress Testing}
   ...
   \chapterimage{stock}
\chapter{Stress Testing and Other Risk Management Tools}

   \chapterimage{stock}
\chapter{Principles for Sound Stress Testing Practices and Supervision}
